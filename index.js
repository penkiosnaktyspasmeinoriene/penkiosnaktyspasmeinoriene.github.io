...
var ASM_CONSTS = {
  62732784: () => { if (document.fullscreenElement) return 1; },  
 62732830: () => { return document.getElementById('canvas').width; },  
 62732882: () => { return parseInt(document.getElementById('canvas').style.width); },  
 62732950: () => { document.exitFullscreen(); },  
 62732977: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 62733050: () => { if (document.fullscreenElement) return 1; },  
 62733096: () => { return document.getElementById('canvas').width; },  
 62733148: () => { return screen.width; },  
 62733173: () => { document.exitFullscreen(); },  
 62733200: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 62733333: () => { return window.innerWidth; },  
 62733359: () => { return window.innerHeight; },  
 62733386: () => { if (document.fullscreenElement) return 1; },  
 62733432: () => { return document.getElementById('canvas').width; },  
 62733484: () => { return parseInt(document.getElementById('canvas').style.width); },  
 62733552: () => { if (document.fullscreenElement) return 1; },  
 62733598: () => { return document.getElementById('canvas').width; },  
 62733650: () => { return screen.width; },  
 62733675: () => { return window.innerWidth; },  
 62733701: () => { return window.innerHeight; },  
 62733728: () => { if (document.fullscreenElement) return 1; },  
 62733774: () => { return document.getElementById('canvas').width; },  
 62733826: () => { return screen.width; },  
 62733851: () => { document.exitFullscreen(); },  
 62733878: () => { if (document.fullscreenElement) return 1; },  
 62733924: () => { return document.getElementById('canvas').width; },  
 62733976: () => { return parseInt(document.getElementById('canvas').style.width); },  
 62734044: () => { document.exitFullscreen(); },  
 62734071: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 62734129: () => { return screen.width; },  
 62734154: () => { return screen.height; },  
 62734180: () => { return window.screenX; },  
 62734207: () => { return window.screenY; },  
 62734234: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 62734287: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 62734358: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 62734415: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 62734671: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 62734742: () => { if (document.fullscreenElement) return 1; },  
 62734788: () => { return window.innerWidth; },  
 62734814: () => { return window.innerHeight; },  
 62734841: () => { if (document.pointerLockElement) return 1; },  
